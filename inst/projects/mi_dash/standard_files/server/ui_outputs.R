...
output$page_title <- renderUI({
  if (is.null(input$page_title)) h1(style = "margin: 0", "Overall Satisfaction")
  else h1(style = "margin: 0", input$page_title)
})

# output$survey_download <- downloadHandler(
#   filename = "NHS Jobs 3 Employer CSAT.pdf",
#   content = function(file) {
#     file.copy("www/NHS Jobs 3 Employer CSAT.pdf", file)
#   }
# )

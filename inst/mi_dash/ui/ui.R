...
source("./ui/pages/overall_satisfaction.R", local = TRUE)
source("./ui/pages/open_comments.R", local = TRUE)
source("./ui/pages/onboarding.R", local = TRUE)
source("./ui/pages/respondent_profile.R", local = TRUE)
### Source pages above
...
content <- div(
  ...
  overall_satisfaction_page,
  open_comments_page,
  onboarding_page,
  respondent_profile_page,
  ### Add pages above
)
...
sidemenu <- div(
  div(
    ...
    a(class = "navigation homeitem item", "Overall Satisfaction", `data-value` = "overall_satisfaction"),
    a(class = "navigation homeitem item", "Open Comments", `data-value` = "open_comments"),
    a(class = "navigation homeitem item", "Onboarding", `data-value` = "onboarding"),
    a(class = "navigation homeitem item", "Respondent Profile", `data-value` = "respondent_profile"),

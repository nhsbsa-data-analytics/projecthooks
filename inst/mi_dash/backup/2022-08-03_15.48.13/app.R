...
server <- function(input, output, session) {
  ...
  source("./server/overall_satisfaction_outputs.R", local = TRUE)
  source("./server/open_comments_outputs.R", local = TRUE)
  source("./server/onboarding_outputs.R", local = TRUE)
  source("./server/respondent_profile_outputs.R", local = TRUE)
  ### Page outputs above
}

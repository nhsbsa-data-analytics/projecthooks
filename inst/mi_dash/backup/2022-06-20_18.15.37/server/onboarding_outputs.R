...
lapply(groups, function(x) {
  output[[glue("onboarding_aspects_rating_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "onboarding_aspects_rating", legend_title = "Rating", radio_select_id = "onboarding_aspects_rating_radio")
  })
})
...
lapply(groups, function(x) {
  output[[glue("challenge_option_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "challenge_option", legend_title = "Challenge")
  })
})
...
lapply(groups, function(x) {
  output[[glue("contact_option_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "contact_option", legend_title = "Method")
  })
})
...
lapply(groups, function(x) {
  output[[glue("contact_instances_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "contact_instances", legend_title = "Number of Contacts")
  })
})
...
lapply(groups, function(x) {
  output[[glue("contact_not_available_option_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "contact_not_available_option", legend_title = "Reason")
  })
})
...
lapply(groups, function(x) {
  output[[glue("contact_how_easy_rating_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "contact_how_easy_rating", cols_start_with = FALSE, legend_title = "Rating")
  })
})
...
lapply(groups, function(x) {
  output[[glue("contact_aspects_rating_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "contact_aspects_rating", legend_title = "Rating", radio_select_id = "contact_aspects_rating_radio")
  })
})
...
lapply(groups, function(x) {
  output[[glue("comms_aspects_rating_{x}")]] <- renderPlotly({
    stacked_vertical(data = filtered_data[[x]], columns = "comms_aspects_rating", legend_title = "Rating", radio_select_id = "comms_aspects_rating_radio")
  })
})

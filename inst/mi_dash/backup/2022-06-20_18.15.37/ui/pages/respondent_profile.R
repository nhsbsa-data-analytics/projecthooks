respondent_profile_page <- div(
  ...
  content_box(
    ...
    fluidRow_2cols_toggle_B(plotlyOutput, "training_option"),
    label("How easy was the training to use?"),
    fluidRow_2cols_toggle_B(plotlyOutput, "training_ease_rating"),
  ...
  content_box(
    ...
    fluidRow_2cols_toggle_B(highchartOutput, "system_used"),
    label("Which other system(s) do you use?"),
    fluidRow_2cols_toggle_B(plotlyOutput, "system_used_option"),

  ...
  t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.calendar = function(t) {
    ...
    return r.each(function() {
      ...
      c = {
        ...
        create: {
          calendar: function() {
            var t, a, n, o, r, i, l, d = c.get.mode(),
              s = new Date,
              u = c.get.date(),
              p = c.get.focusDate(),
            ...
            for (A.empty(), j > 1 && (l = e("<div/>").addClass(h.grid).appendTo(A)), o = 0; o < j; o++) {
              ...
              if (!w) {
                ...
                if (b)
                  for (r = e("<tr/>").appendTo(G), t = 0; t < Y; t++) i = e("<th/>").appendTo(r), i.text(v.dayColumnHeader((t + f.firstDayOfWeek) % 7, f))
              }
              var ae = e("<tbody/>").appendTo(Z);
              for (t = m ? 10 * Math.ceil(N / 10) - 9 : b ? 1 - P : 0, a = 0; a < R; a++)
        ...
        invoke: function(t, a, r) {
          ...
          return a = a || p, r = F || r, "string" == typeof t && s !== n && (t = t.split(/[\. ]/), i = t.length - 1, e.each(t, function(a, o) {
            ...
            if (e.isPlainObject(s[r]) && a != i) s = s[r];
            else {
    ...
    parser: {
      date: function(t, a) {
        ...
        if (!h)
          for (c = e.inArray(a.text.am.toLowerCase(), g) >= 0 || !(e.inArray(a.text.pm.toLowerCase(), g) >= 0) && n, o = 0; o < m.length; o++) {
            var v = m[o];
            if (v.indexOf(":") >= 0) {
              if (d < 0 || l < 0) {
                var y = v.split(":");

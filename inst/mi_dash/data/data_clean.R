...
source("server/output_functions.R")
...
## Create app.R -----------------------------------------------------------
try(create_app_r(app_title, backup_dir, overwrite = overwrite, open = open))

## Create ui.R ------------------------------------------------------------
try(create_ui_r(main_title, subtitle, ui_backup_dir, overwrite = overwrite, open = open))
